...
import com.jeesite.modules.bp.edu.packt.neuralnet.*;
...
public class DeltaRule extends LearningAlgorithm {
    ...
    public void print(){
        if(learningMode==LearningMode.ONLINE)
            System.out.println("迭代次数="+String.valueOf(epoch)+"; 正确记录="
                    +String.valueOf(currentRecord)+"; 总误差="
                    +String.valueOf(overallGeneralError));
        else
            System.out.println("迭代次数= "+String.valueOf(epoch)
                    +"; 总误差 ="+String.valueOf(overallGeneralError));
    }
